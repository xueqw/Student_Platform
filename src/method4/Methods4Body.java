...
public class Methods4Body extends JFrame implements ActionListener {
    ...
    public void OriginalPage() {
        ...
        JLabel background = new JLabel(new ImageIcon("src\\method4\\诚实一点.png"));
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (obj == jtb1) {
            try {
                ...
                JLabel NotHonest = new JLabel(new ImageIcon("src\\method4\\诚实不了一点.png"));
            ...
            JLabel happen = new JLabel(new ImageIcon("src\\method4\\无事发生.png"));
            ...
            JLabel end = new JLabel(new ImageIcon("src\\method4\\算你识相.png"));
